...
\sigla{rgb}{RGB}{Vermelho Verde e Azul \textit{RED GREEN and BLUE}}
\sigla{hsi}{HSI}{\textit{ Matiz Saturaçãoe Intensidade \textit{Hue Saturation and Intensity}}}
\sigla{hog}{HOG}{\textit{Histogram of Oriented Gradients}}
