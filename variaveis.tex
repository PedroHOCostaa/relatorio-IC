...
% TCC2:
 \goal{Atividade de Inteligência Computacional}
 \course{Inteligência Computacional}


% Dados do TCC (precisa alterar)
% Use \\ para quebrar a linha e colocar um nome abaixo do outro na capa
\author{Pedro Henrique de Oliveira Costa \\ Felipe Martins \\ Herbert Cardozo}

% Para a referência bibliográfica, a norma ABNT pede separação por ponto e vírgula (;)
\authorbib{Costa, Pedro; Martins, Felipe; Cardozo, Herbert}

\title{Classificadores dos Personagens do Simpsons} % Título do trabalho
\titleen{Simpsons Characters Classifiers} % Título traduzido para inglês
\advisor{Profº Bertonili} % Nome do orientador. Lembre-se de prefixar com "Prof. Dr.", "Profª. Drª.", "Prof. Me." ou "Profª. Me."}
...
\PalavraChaveA{Inteligencia computacional}%% Palavra-chave A
\PalavraChaveB{Classificadores}%% Palavra-chave B
\PalavraChaveC{Analise de imagens}%% Palavra-chave C
\PalavraChaveD{Extra\c{c}\~ao de caracter\'isticas}%% Palavra-chave D
\PalavraChaveE{Combina\c{c}\~ao est\'atica de classificadores}%% Palavra-chave E
