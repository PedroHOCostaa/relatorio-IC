# Classificação de Imagens dos Simpsons (HOG + Cor + 5 Classificadores + Ensemble)
...
- Extração de atributos: Histogram of Oriented Gradients (HOG) + histogramas de cor RGB (8 bins/canal).
